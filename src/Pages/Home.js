                    ...
                    <div className="home-text wow fadeIn text-center">
                      <h1 className="cd-headline clip is-full-width">
                        <span
                          ...
                          style={{ width: "430px", overflow: "hidden" }}
                        >
                  ...
                  <div className="row">
                    <div className="col-md-12">
                      <div className="main-title text-center wow fadeIn">
                        ...
                        <div className="underline2"></div>
                        <p>
                        BrainGain Tutoring is a student-led organization dedicated to making a positive impact on the lives of underprivileged children in the GTA. Recognizing the disparity in educational opportunities faced by these children, we have come together with a shared vision of creating a brighter future for them through education. Our team consists of passionate and dedicated student tutors who believe in the power of education to transform lives. We strive to provide personalized tutoring services that cater to the unique needs and learning styles of each child we serve. Our tutors are selected through a rigorous process, ensuring their competence in various subjects and their ability to create a supportive and engaging learning environment. We are driven by our commitment to equity and social justice, and we firmly believe that education should be accessible to all, regardless of economic circumstances. By partnering with local schools, community centers, and organizations, we identify and reach out to children who would benefit most from our tutoring services. At BrainGain Tutoring, we go beyond academic support. We aim to instill confidence, motivation, and a growth mindset in our students, empowering them to overcome obstacles and achieve their full potential. Through mentorship and guidance, we not only assist with homework and subject-specific concepts but also foster critical thinking, problem-solving skills, and a lifelong love for learning. We are dedicated to building strong relationships with the children and families we serve, and we strive to create a safe and inclusive space where every child feels valued and supported. By nurturing their intellectual curiosity and helping them develop essential skills, we aim to equip these children with the tools they need to succeed academically and in life.
                        </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="row">
                  <div className="col-md-12">
                    <div className="main-title text-center wow fadeIn">
                      ...
                      <div className="underline2"></div>
                      <p>
                        our team is so dumb lul, especially chairman !1?#@!@#
                      </p>
                    </div>
                  </div>
                </div>
